...
import { TriggerOrchestratorService } from '../trigger-orchestrator.service';
...
describe('TriggerOrchestratorService (property-based)', () => {
  let engine: TriggerOrchestratorService;
  ...
  beforeEach(() => {
    ...
    engine = new TriggerOrchestratorService(
